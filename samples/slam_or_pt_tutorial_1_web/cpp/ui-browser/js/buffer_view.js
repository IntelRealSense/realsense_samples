 ...
 * @param type: message type - Fisheye
 * For Fisheye BufferViewerShader is BufferViewerShader.FRAGMENT
 * For non Fisheye frames, BufferViewerShader is
 * BufferViewerShader.FRAGMENT_YUV (which is also default)
 */
class BufferViewer {
    constructor(type) {
        this.uniforms = {};
    ...
    init(canvas) {
        ...
        var bufferViewerShader = BufferViewerShader.FRAGMENT_YUV;
		if(this.type === "Fisheye"){
			bufferViewerShader = BufferViewerShader.FRAGMENT;
		}

        let material = new THREE.ShaderMaterial({
            uniforms: this.uniforms,
            vertexShader: BufferViewerShader.VERTEX,
           // fragmentShader: BufferViewerShader.FRAGMENT
           fragmentShader: bufferViewerShader
        });
