...
var JpegImage = function jpegImage() {
    ...
    JpegImage.prototype = {
        ...
        getData: function(width, height, leaveAsYcc) {
            return this._parser.getData(width, height, false, !!leaveAsYcc);
        },
...
(function(PDFJS) {
    ...
    var JpegImage = function jpegImage() {
        ...
        constructor.prototype = {
            ...
            getData: function getData(width, height, forceRGBoutput, leaveAsYcc) {
                if (this.numComponents > 4) {
                    throw "Unsupported color mode";
                }
                var data = this._getLinearizedBlockData(width, height);
                if (this.numComponents === 3 && !leaveAsYcc) {
